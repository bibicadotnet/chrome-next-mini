...
// ============================================================
#pragma comment(linker, "/export:GetFileVersionInfoA=_GetFileVersionInfoA_fw@0,@1")
#pragma comment(linker, "/export:GetFileVersionInfoByHandle=_GetFileVersionInfoByHandle_fw@0,@2")
#pragma comment(linker, "/export:GetFileVersionInfoExA=_GetFileVersionInfoExA_fw@0,@3")
#pragma comment(linker, "/export:GetFileVersionInfoExW=_GetFileVersionInfoExW_fw@0,@4")
#pragma comment(linker, "/export:GetFileVersionInfoSizeA=_GetFileVersionInfoSizeA_fw@0,@5")
#pragma comment(linker, "/export:GetFileVersionInfoSizeExA=_GetFileVersionInfoSizeExA_fw@0,@6")
#pragma comment(linker, "/export:GetFileVersionInfoSizeExW=_GetFileVersionInfoSizeExW_fw@0,@7")
#pragma comment(linker, "/export:GetFileVersionInfoSizeW=_GetFileVersionInfoSizeW_fw@0,@8")
#pragma comment(linker, "/export:GetFileVersionInfoW=_GetFileVersionInfoW_fw@0,@9")
#pragma comment(linker, "/export:VerFindFileA=_VerFindFileA_fw@0,@10")
#pragma comment(linker, "/export:VerFindFileW=_VerFindFileW_fw@0,@11")
#pragma comment(linker, "/export:VerInstallFileA=_VerInstallFileA_fw@0,@12")
#pragma comment(linker, "/export:VerInstallFileW=_VerInstallFileW_fw@0,@13")
#pragma comment(linker, "/export:VerLanguageNameA=_VerLanguageNameA_fw@0,@14")
#pragma comment(linker, "/export:VerLanguageNameW=_VerLanguageNameW_fw@0,@15")
#pragma comment(linker, "/export:VerQueryValueA=_VerQueryValueA_fw@0,@16")
#pragma comment(linker, "/export:VerQueryValueW=_VerQueryValueW_fw@0,@17")
